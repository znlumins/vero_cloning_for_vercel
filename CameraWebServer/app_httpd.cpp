...
// Face Detection/Recognition disabled: the esp-face library headers
// (human_face_detect_msr01.hpp etc.) aren't installed, and this project
// doesn't need the feature (camera streaming + BH1750/VL53L1X only).
...
static int led_gpio_num = -1; // set by setupLedFlash(); ledcWrite() addresses by pin in core 3.x
